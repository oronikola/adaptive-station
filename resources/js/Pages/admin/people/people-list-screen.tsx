                        ...
                        people.data.length === 0 ? (
                            <div className="py-16 text-center">
                                ...
                                <p className="mx-auto mt-1 max-w-sm text-xs text-slate-500 dark:text-slate-400">
                                    Try adjusting your search filters or add a new person to your school roster.
                                </p>
                                <button
                                    type="button"
                                    onClick={() => setAddPersonOpen(true)}
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="border-t border-slate-100 pt-3 dark:border-slate-800">
                                                <Link
                                                    href={route('portal.people.edit', person.id)}
                                                    className="pf-row-action !w-full justify-center !py-2 rounded-xl text-xs font-semibold"
                                                >
                                                    View Profile
                                                    <svg viewBox="0 0 24 24">
                                                        <path d="M9 6l6 6-6 6" />
