...
function TapSignalIcon({ className = 'h-6 w-6' }) {
    return (
        <svg
            className={className}
            viewBox="0 0 24 24"
...
function CloudIcon({ className = 'h-6 w-6' }) {
    return (
        <svg
            className={className}
            viewBox="0 0 24 24"
...
function LinkIcon({ className = 'h-6 w-6' }) {
    return (
        <svg
            className={className}
            viewBox="0 0 24 24"
...
function FinalCallToAction({ workspaceHref, workspaceLabel }) {
    return (
