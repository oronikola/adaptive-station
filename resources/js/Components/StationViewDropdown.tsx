                        ...
                        >
                            ...
                            <div className="border-b border-slate-100 bg-slate-50/80 px-5 py-3.5 dark:border-gray-800 dark:bg-gray-800/40">
                                ...
                                <div className="mt-3 flex items-center gap-1 rounded-xl bg-slate-200/70 p-1 dark:bg-gray-800">
                                    ...
                                    >
                                        <GraduationCapIcon size={14} className="text-blue-600" />
                                        School Switcher
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <MonitorCheckIcon size={14} className="text-indigo-600" />
                                        Station View
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <CompassIcon size={14} className="text-emerald-600" />
                                        Specific Station
                                    </button>
                                </div>
                            </div>
                                ...
                                {(activeTab === 'all' || activeTab === 'school') && (
                                    <div className="py-3">
                                        ...
                                        <div className="space-y-1 max-h-48 overflow-y-auto pr-1">
                                            ...
                                            >
                                                <div className="flex items-center gap-2">
                                                    <EarthIcon size={14} className="text-blue-500" />
                                                ...
                                                {!currentTenantId && (
                                                    <CheckIcon size={16} className="text-blue-600 ml-2" />
                                                )}
                                            </button>
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex items-center gap-1.5 shrink-0">
                                                                ...
                                                                <ChevronRightIcon size={14} className="text-slate-400 transition-transform group-hover:translate-x-0.5 group-hover:text-slate-600" />
                                                            </div>
                                                        </button>
                                                    );
                                                })
