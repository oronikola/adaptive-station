...
const DropdownLink = ({ className = '', children, href, method, as, ...props }: { className?: string; children?: React.ReactNode; href: string; method?: string; as?: string } & Record<string, unknown>) => {
    return (
        <Link
            href={href}
