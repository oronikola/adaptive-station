...
class DeviceActivationController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            // StationActivationCode::redeem() resolves before any tenant
            // context exists, so the station must be fetched explicitly
            // bypassing TenantScope rather than via the credential's relation.
