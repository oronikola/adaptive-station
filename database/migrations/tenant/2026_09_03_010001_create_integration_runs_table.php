...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->getConnection())->create('integration_runs', function (Blueprint $table) {
    ...
    {
        Schema::connection($this->getConnection())->dropIfExists('integration_runs');
    }
};
