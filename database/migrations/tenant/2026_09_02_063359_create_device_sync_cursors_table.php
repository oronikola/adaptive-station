...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->getConnection())->create('device_sync_cursors', function (Blueprint $table) {
    ...
    {
        Schema::connection($this->getConnection())->dropIfExists('device_sync_cursors');
    }
};
